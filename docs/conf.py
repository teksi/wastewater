...
# Disable numbering of section titles
numfig = True       # Figures, tables, code-blocks get numbered
secnum_depth = 0    # Section titles stay unnumbered
...
man_pages = [("index", "tww", "TWW Documentation", ["The TWW Project/OPENGIS.ch"], 1)]
