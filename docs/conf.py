# -*- coding: utf-8 -*-
#
# TWW documentation build configuration file, created by
...
project = u'TWW'
copyright = u'2023, The TWW Project www.teksi.ch'
...
latex_documents = [
  ('index', 'TWW.tex', u'TWW Documentation',
   u'The TWW Project/OPENGIS.ch', 'manual'),
]
...
man_pages = [
    ('index', 'tww', u'TWW Documentation',
     [u'The TWW Project/OPENGIS.ch'], 1)
]
...
texinfo_documents = [
  ('index', 'TWW', u'TWW Documentation',
   u'The TWW Project/OPENGIS.ch', 'TWW', 'One line description of project.',
   'Miscellaneous'),
]
