...
- First version of TEKSI wastewater module for QGIS 3.40 LTR and initialized and upgrade via the PostgreSQL Update Manager (PUM) and the TEKSI Module Management Tool (TMMT).
...
TO DO: Check if this link has to be adapted
https://teksi.github.io/wastewater/latest/fr/installation-guide/workstation.html#install-tww-plugin - should be adapted to do it with TMMT



 - `The OID Prefix can be set in TMMT from 2026.0.1 on <../admin-guide/db-production-readiness/index.html>`_
 - `The 'Extend selection tool' allows users to expand a selection made on the vw_tww_reach layer to related objects <../user-guide/editing/editing.html>`_
...
Please use the corresponding :literal:`* \ `.qml files to integrate them into existing TWW 2025 project files

TO DO: create the qml files ?
