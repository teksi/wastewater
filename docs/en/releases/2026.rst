...
Main features
----------------
- Version of TEKSI wastewater module for QGIS 3.44 LTR and initialized and upgrade via the PostgreSQL Update Manager (PUM) and the TEKSI Module Management Tool (TMMT).
...
--------------
 ...
 - Update README.md Italian docs
 - Restore documentation structure with version/language
 - Update AG-XX docs
 - Add italian for docs

Bug fixes and performance improvements
-----------------------------------------
 - Add standardoid as domain
 - Remove qgis dependency from cmd
 - Check that layers are not in edit mode for admin actions
 - Fix display_fr translation
 - Fix a bug where overflows couldn't be removed
 - Fix Error with depth calculation when updating a node or cover
 - add from and to levels to tww_app.mvw_tww_channel
 - labels-export-prevent-crash-if-no-labels
 - Check tww_app.vw_tww_wastewater_node existence
 - add integrity checks to manual validity checks
 - Add option to suppress selection dialog on xtf import


Extension improvements
----------------------
 - Fix Bug in gepknoten and gephaltung agxx export view

Adaptions to project file
----------------------------------------

 - fix Elecromechanical in project
 - fix Generell in project
