...
class SwmmExecuteAlgorithm(TwwAlgorithm):
    ...
    def shortHelpString(self):
        ...
        Launch a swmm simulation.
         ...
         See: https://teksi.github.io/wastewater/latest/en/tww_swmm/Run-SWMM-Simulation.html#run-a-simulation-with-tww-swmm
         """)

    def helpUrl(self):
        return "https://teksi.github.io/wastewater/latest/en/tww_swmm/Run-SWMM-Simulation.html#run-a-simulation-with-tww-swmm"
