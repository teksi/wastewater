...
UPDATE tww_od.manhole SET dimension1=4000 WHERE dimension1>4000;
UPDATE tww_od.manhole SET dimension2=4000 WHERE dimension2>4000;
...
UPDATE tww_od.reach SET progression_geometry=ST_RemoveRepeatedPoints(progression_geometry, 0.002) WHERE NOT ST_EQUALS(progression_geometry, ST_RemoveRepeatedPoints(progression_geometry, 0.001));
...
DELETE FROM tww_od.reach WHERE obj_id='ch13p7mzRE009663';
