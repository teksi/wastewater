...
-- you need to set the current maxvalue of the TID into the schema.table.field abwa_2015neu_3122.t_key_object.t_lastuniqueid
...
CREATE OR REPLACE FUNCTION abwa_2015neu_3122.tid_generate(table_name text, obj_id_table text)
  -- RETURNS text AS
  RETURNS integer AS
$BODY$
DECLARE
