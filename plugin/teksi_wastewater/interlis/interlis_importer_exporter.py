...
class InterlisImporterExporter:
    ...
    def interlis_import(self, xtf_file_input, show_selection_dialog=False, logs_next_to_file=True):
        ...
        self._progress_done(35, "Disable symbology and last modification triggers...")
        self._import_disable_symbology_and_lastmod_triggers()
        ...
        try:
            ...
            self._import_enable_symbology_and_lastmod_triggers()
    ...
    def _import_disable_symbology_and_lastmod_triggers(self):
        DatabaseUtils.disable_symbology_triggers()
        DatabaseUtils.disable_last_modification_triggers()

    def _import_enable_symbology_and_lastmod_triggers(self):
        DatabaseUtils.enable_symbology_triggers()
        DatabaseUtils.update_symbology()
        DatabaseUtils.enable_last_modification_triggers()
