DROP VIEW IF EXISTS tww_od.vw_tank_cleaning;
...
--------
CREATE OR REPLACE VIEW tww_od.vw_tank_cleaning AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_tank_cleaning_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_tank_cleaning_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_tank_cleaning
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_tank_cleaning_insert();
...
CREATE OR REPLACE RULE vw_tank_cleaning_ON_UPDATE AS ON UPDATE TO tww_od.vw_tank_cleaning DO INSTEAD (
...
CREATE OR REPLACE RULE vw_tank_cleaning_ON_DELETE AS ON DELETE TO tww_od.vw_tank_cleaning DO INSTEAD (
