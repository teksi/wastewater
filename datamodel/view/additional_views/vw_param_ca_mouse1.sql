DROP VIEW IF EXISTS tww_od.vw_param_ca_mouse1;
...
--------
CREATE OR REPLACE VIEW tww_od.vw_param_ca_mouse1 AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_param_ca_mouse1_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_param_ca_mouse1_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_param_ca_mouse1
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_param_ca_mouse1_insert();
...
CREATE OR REPLACE RULE vw_param_ca_mouse1_ON_UPDATE AS ON UPDATE TO tww_od.vw_param_ca_mouse1 DO INSTEAD (
...
CREATE OR REPLACE RULE vw_param_ca_mouse1_ON_DELETE AS ON DELETE TO tww_od.vw_param_ca_mouse1 DO INSTEAD (
