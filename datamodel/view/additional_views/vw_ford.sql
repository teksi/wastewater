DROP VIEW IF EXISTS tww_od.vw_ford;
...
--------
CREATE OR REPLACE VIEW tww_od.vw_ford AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_ford_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_ford_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_ford
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_ford_insert();
...
CREATE OR REPLACE RULE vw_ford_ON_UPDATE AS ON UPDATE TO tww_od.vw_ford DO INSTEAD (
--------
-- UPDATE tww_od.ford
--  SET
...
CREATE OR REPLACE RULE vw_ford_ON_DELETE AS ON DELETE TO tww_od.vw_ford DO INSTEAD (
