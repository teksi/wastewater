DROP VIEW IF EXISTS tww_od.vw_electric_equipment;
...
--------
CREATE OR REPLACE VIEW tww_od.vw_electric_equipment AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_electric_equipment_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_electric_equipment_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_electric_equipment
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_electric_equipment_insert();
...
CREATE OR REPLACE RULE vw_electric_equipment_ON_UPDATE AS ON UPDATE TO tww_od.vw_electric_equipment DO INSTEAD (
...
CREATE OR REPLACE RULE vw_electric_equipment_ON_DELETE AS ON DELETE TO tww_od.vw_electric_equipment DO INSTEAD (
