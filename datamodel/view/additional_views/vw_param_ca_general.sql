DROP VIEW IF EXISTS tww_od.vw_param_ca_general;
...
--------
CREATE OR REPLACE VIEW tww_od.vw_param_ca_general AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_param_ca_general_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_param_ca_general_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_param_ca_general
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_param_ca_general_insert();
...
CREATE OR REPLACE RULE vw_param_ca_general_ON_UPDATE AS ON UPDATE TO tww_od.vw_param_ca_general DO INSTEAD (
...
CREATE OR REPLACE RULE vw_param_ca_general_ON_DELETE AS ON DELETE TO tww_od.vw_param_ca_general DO INSTEAD (
