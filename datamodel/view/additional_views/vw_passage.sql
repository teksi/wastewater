DROP VIEW IF EXISTS tww_od.vw_passage;
...
--------
CREATE OR REPLACE VIEW tww_od.vw_passage AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_passage_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_passage_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_passage
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_passage_insert();
...
CREATE OR REPLACE RULE vw_passage_ON_UPDATE AS ON UPDATE TO tww_od.vw_passage DO INSTEAD (
--------
...
CREATE OR REPLACE RULE vw_passage_ON_DELETE AS ON DELETE TO tww_od.vw_passage DO INSTEAD (
