DROP VIEW IF EXISTS tww_od.vw_groundwater_protection_zone;
...
-- Superclass: zone
--------
CREATE OR REPLACE VIEW tww_od.vw_groundwater_protection_zone AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_groundwater_protection_zone_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_groundwater_protection_zone_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_groundwater_protection_zone
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_groundwater_protection_zone_insert();
...
CREATE OR REPLACE RULE vw_groundwater_protection_zone_ON_UPDATE AS ON UPDATE TO tww_od.vw_groundwater_protection_zone DO INSTEAD (
...
CREATE OR REPLACE RULE vw_groundwater_protection_zone_ON_DELETE AS ON DELETE TO tww_od.vw_groundwater_protection_zone DO INSTEAD (
