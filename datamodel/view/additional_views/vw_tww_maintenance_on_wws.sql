-- View: tww_od.vw_tww_maintenance_on_wws

-- DROP VIEW tww_od.vw_tww_maintenance_on_wws;

CREATE OR REPLACE VIEW tww_od.vw_tww_maintenance_on_wws AS 
...
ALTER TABLE tww_od.vw_tww_maintenance_on_wws
  OWNER TO postgres;
GRANT ALL ON TABLE tww_od.vw_tww_maintenance_on_wws TO postgres;
GRANT ALL ON TABLE tww_od.vw_tww_maintenance_on_wws TO tww;
