DROP VIEW IF EXISTS tww_od.vw_blocking_debris;
...
--------
CREATE OR REPLACE VIEW tww_od.vw_blocking_debris AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_blocking_debris_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_blocking_debris_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_blocking_debris
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_blocking_debris_insert();
...
CREATE OR REPLACE RULE vw_blocking_debris_ON_UPDATE AS ON UPDATE TO tww_od.vw_blocking_debris DO INSTEAD (
...
CREATE OR REPLACE RULE vw_blocking_debris_ON_DELETE AS ON DELETE TO tww_od.vw_blocking_debris DO INSTEAD (
