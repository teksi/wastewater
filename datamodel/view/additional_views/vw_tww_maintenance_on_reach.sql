-- View: tww_od.vw_tww_maintenance_on_reach

-- DROP VIEW tww_od.vw_tww_maintenance_on_reach;

CREATE OR REPLACE VIEW tww_od.vw_tww_maintenance_on_reach AS 
...
ALTER TABLE tww_od.vw_tww_maintenance_on_reach
  OWNER TO postgres;
GRANT ALL ON TABLE tww_od.vw_tww_maintenance_on_reach TO postgres;
GRANT ALL ON TABLE tww_od.vw_tww_maintenance_on_reach TO tww;
