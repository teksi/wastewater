DROP VIEW IF EXISTS tww_od.vw_ground_water_protection_perimeter;
...
-- Superclass: zone
--------
CREATE OR REPLACE VIEW tww_od.vw_ground_water_protection_perimeter AS
...
CREATE OR REPLACE FUNCTION tww_od.vw_ground_water_protection_perimeter_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_ground_water_protection_perimeter_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_ground_water_protection_perimeter
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_ground_water_protection_perimeter_insert();
...
CREATE OR REPLACE RULE vw_ground_water_protection_perimeter_ON_UPDATE AS ON UPDATE TO tww_od.vw_ground_water_protection_perimeter DO INSTEAD (
...
CREATE OR REPLACE RULE vw_ground_water_protection_perimeter_ON_DELETE AS ON DELETE TO tww_od.vw_ground_water_protection_perimeter DO INSTEAD (
