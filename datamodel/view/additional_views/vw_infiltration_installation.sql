...
--------
CREATE OR REPLACE VIEW tww_od.vw_infiltration_installation AS
...
SELECT
 ...
 LEFT JOIN tww_od.wastewater_structure WS
...
CREATE OR REPLACE FUNCTION tww_od.vw_infiltration_installation_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
-- DROP TRIGGER vw_infiltration_installation_ON_INSERT ON tww_od.infiltration_installation;

CREATE TRIGGER vw_infiltration_installation_ON_INSERT INSTEAD OF INSERT ON tww_od.vw_infiltration_installation
  FOR EACH ROW EXECUTE PROCEDURE tww_od.vw_infiltration_installation_insert();
...
CREATE OR REPLACE RULE vw_infiltration_installation_ON_UPDATE AS ON UPDATE TO tww_od.vw_infiltration_installation DO INSTEAD (
UPDATE tww_od.infiltration_installation
  SET
...
CREATE OR REPLACE RULE vw_infiltration_installation_ON_DELETE AS ON DELETE TO tww_od.vw_infiltration_installation DO INSTEAD (
