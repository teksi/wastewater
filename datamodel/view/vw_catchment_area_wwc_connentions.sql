-- View: tww_od.vw_catchment_area_wwc_connections

-- DROP VIEW tww_od.vw_catchment_area_wwc_connections;

CREATE OR REPLACE VIEW tww_od.vw_catchment_area_wwc_connections AS
 SELECT ca.obj_id,
