-- View: tww_od.vw_catchment_area_rwc_connections

-- DROP VIEW tww_od.vw_catchment_area_rwc_connections;

CREATE OR REPLACE VIEW tww_od.vw_catchment_area_rwc_connections AS 
 SELECT ca.obj_id,
