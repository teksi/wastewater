...
GRANT USAGE ON SCHEMA tww_network  TO tww_viewer;
GRANT USAGE ON SCHEMA tww_import   TO tww_viewer;
GRANT USAGE ON SCHEMA tww_swmm     TO tww_viewer;
...
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA tww_network  TO tww_viewer;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA tww_import   TO tww_viewer;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA tww_swmm     TO tww_viewer;
...
GRANT SELECT, REFERENCES, TRIGGER ON ALL TABLES IN SCHEMA tww_network  TO tww_viewer;
GRANT SELECT, REFERENCES, TRIGGER ON ALL TABLES IN SCHEMA tww_import   TO tww_viewer;
GRANT SELECT, REFERENCES, TRIGGER ON ALL TABLES IN SCHEMA tww_swmm     TO tww_viewer;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA tww_network  GRANT SELECT, REFERENCES, TRIGGER ON TABLES TO tww_viewer;
ALTER DEFAULT PRIVILEGES IN SCHEMA tww_import  GRANT SELECT, REFERENCES, TRIGGER ON TABLES TO tww_viewer;
ALTER DEFAULT PRIVILEGES IN SCHEMA tww_swmm  GRANT SELECT, REFERENCES, TRIGGER ON TABLES TO tww_viewer;
...
GRANT ALL ON ALL TABLES IN SCHEMA tww_network TO tww_user;
...
GRANT ALL ON ALL TABLES IN SCHEMA tww_import TO tww_user;
