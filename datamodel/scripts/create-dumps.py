...
File | Description
------------ | -------------
tww_{version}_structure{'_'+extension_name if extension_name else ''}.sql | Contains the structure of tables and system schema content
tww_{version}_structure_with_value_lists{'_'+extension_name if extension_name else ''}.sql | Contains the structure of tables, system schema data and value lists data
tww_{version}_demo_data{'_'+extension_name if extension_name else ''}.backup | Data-only backup of the `tww_od` schema (i.e. ordinary data) from demonstration set of data
tww_{version}_structure_and_demo_data{'_'+extension_name if extension_name else ''}.backup | Complete backup with structure and data of the demonstration set of data
