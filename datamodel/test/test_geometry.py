...
class TestViews(unittest.TestCase, DbTestBase):
    ...
    def test_vw_tww_reach_geometry_insert(self):
        ...
        # INSERT INTO tww_app.vw_tww_reach (obj_id, progression_geometry, rp_to_level, rp_from_obj_id, rp_to_obj_id) VALUES ('AAA 1337_0002', ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 3,4 5 6,7 8 9))'), 2056), 66, 'BBB 1337_0002', 'CCC 1337_0002' );
        row = {
            "progression_geometry": "01090000A00808000001000000010200008003000000000000000000F03F000000000000004000000000000008400000000000001040000000000000144000000000000018400000000000001C4000000000000020400000000000002240",
            "rp_to_level": "66",
        ...
        # INSERT INTO tww_app.vw_tww_reach (obj_id, progression_geometry, rp_from_level, rp_to_level, rp_from_obj_id, rp_to_obj_id) VALUES ('AAA 1337_0003', ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 3,4 5 6,7 8 9))'), 2056), NULL, 77, 'BBB 1337_0003', 'CCC 1337_0003' );
        row = {
            "progression_geometry": "01090000A00808000001000000010200008003000000000000000000F03F000000000000004000000000000008400000000000001040000000000000144000000000000018400000000000001C4000000000000020400000000000002240",
    ...
    def test_vw_tww_reach_geometry_update(self):
        ...
        # INSERT INTO tww_app.vw_tww_reach (progression_geometry, rp_from_obj_id, rp_to_obj_id) VALUES (ST_SetSRID( ST_ForceCurve(ST_MakeLine(ARRAY[ST_MakePoint(1,2,'NaN'), ST_MakePoint(4,5,'NaN'), ST_MakePoint(7,8,'NaN')])), 2056), 'BBB 1337_1010', 'CCC 1337_1010' );
        row = {
        ...
        # UPDATE INTO tww_app.vw_tww_reach SET progression_geometry=ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 3,4 5 6,7 8 9))'), 2056) WHERE obj_id=obj_id'
        row = {
            "progression_geometry": "01090000A00808000001000000010200008003000000000000000000F03F000000000000004000000000000008400000000000001040000000000000144000000000000018400000000000001C4000000000000020400000000000002240"
        }
        ...
        # UPDATE INTO tww_app.vw_tww_reach SET progression_geometry=ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 33,4 5 6,7 8 99))'), 2056), rp_to_level=NULL WHERE obj_id=obj_id'
        row = {
        ...
        # UPDATE INTO tww_app.vw_tww_reach SET progression_geometry=ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 300,4 5 6,7 8 900))'), 2056), rp_to_level=NULL WHERE obj_id=obj_id'
        row = {
        ...
        # UPDATE INTO tww_app.vw_tww_reach SET progression_geometry=ST_SetSRID( ST_ForceCurve(ST_MakeLine(ARRAY[ST_MakePoint(1,2,'NaN'), ST_MakePoint(4,5,6), ST_MakePoint(7,8,'NaN')])), 2056) WHERE obj_id=obj_id'
        row = {
    ...
    def test_vw_tww_wastewater_structure_geometry_insert(self):
        ...
        # INSERT INTO tww_app.vw_tww_wastewater_structure (situation_geometry, wn_obj_id, co_obj_id, wn_bottom_level) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056), '1337_1002', '1337_1002', 200.000);
        row = {
            "situation_geometry": "0101000020080800000000000020D6434100000000804F3241",
            "wn_obj_id": "1337_1002",
            "co_obj_id": "1337_1002",
        ...
        # INSERT INTO tww_app.vw_tww_wastewater_structure (situation_geometry, wn_obj_id, co_obj_id, wn_bottom_level, co_level) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056), '1337_1003', '1337_1003', 200.000, 500.000);
        row = {
            "situation_geometry": "0101000020080800000000000020D6434100000000804F3241",
            "wn_obj_id": "1337_1003",
            "co_obj_id": "1337_1003",
    ...
    def test_vw_tww_wastewater_structure_geometry_update(self):
        ...
        # INSERT INTO tww_app.vw_tww_wastewater_structure (situation_geometry, wn_obj_id, co_obj_id) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056), '1337_1010', '1337_1010');
        row = {
            "situation_geometry": "0101000020080800000000000020D6434100000000804F3241",
            "ws_type": "manhole",
            "wn_obj_id": "1337_1010",
    ...
    def test_wastewater_node_geometry_sync_on_insert(self):
        ...
        # INSERT INTO tww_app.vw_wastewater_node (bottom_level, situation_geometry) VALUES (200, ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056) );
        row = {
        ...
        # INSERT INTO tww_app.vw_wastewater_node (bottom_level, situation_geometry) VALUES (200, ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
        row = {
            "bottom_level": "200.000",
        ...
        # INSERT INTO tww_app.vw_wastewater_node (bottom_level, situation_geometry) VALUES (NULL, ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
        row = {
            "bottom_level": None,
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
        }
        ...
        # INSERT INTO tww_app.vw_wastewater_node (situation_geometry) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
        row = {
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
        }
        expected_row = copy.deepcopy(row)
    ...
    def test_wastewater_node_geometry_sync_on_update(self):
        ...
        # UPDATE INTO tww_app.vw_wastewater_node SET situation_geometry=ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) WHERE obj_id = obj_id;
        row = {
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
        }
        ...
        # UPDATE INTO tww_app.vw_wastewater_node SET situation_geometry=ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056) WHERE obj_id = obj_id;
        row = {
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F3241000000000000F87F",
        }
        self.update("vw_wastewater_node", row, obj_id)
    ...
    def test_cover_geometry_sync_on_insert(self):
        ...
        # INSERT INTO tww_app.vw_cover (level, situation_geometry) VALUES (200, ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056) );
        row = {
            "level": "200.000",
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F3241000000000000F87F",
        }
        ...
        # INSERT INTO tww_app.vw_cover (level, situation_geometry) VALUES (200, ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
        row = {
            "level": "200.000",
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
        }
        ...
        # INSERT INTO tww_app.vw_cover (level, situation_geometry) VALUES (NULL, ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
        row = {
            "level": None,
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
        }
        ...
        # INSERT INTO tww_app.vw_cover (situation_geometry) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
        row = {
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
        }
        expected_row = copy.deepcopy(row)
    ...
    def test_cover_geometry_sync_on_update(self):
        ...
        # UPDATE INTO tww_app.vw_cover SET situation_geometry=ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) WHERE obj_id = obj_id;
        row = {
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
        }
        ...
        # UPDATE INTO tww_app.vw_cover SET situation_geometry=ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056) WHERE obj_id = obj_id;
        row = {
            "situation_geometry": "01010000A0080800000000000020D6434100000000804F3241000000000000F87F",
        }
        self.update("vw_cover", row, obj_id)
