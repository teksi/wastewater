...
CREATE TRIGGER on_gepknoten_insert
    ...
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_gepknoten_insert();

DROP TRIGGER IF EXISTS on_gepknoten_upsate ON tww_app.vw_agxx_gepknoten;
CREATE TRIGGER on_gepknoten_upsate
    INSTEAD OF UPDATE 
    ON tww_app.vw_agxx_gepknoten
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_gepknoten_update();
...
CREATE TRIGGER on_gepknoten_delete
    ...
    ON tww_app.vw_agxx_gepknoten
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_gepknoten_delete();
...
CREATE TRIGGER on_gephaltung_insert
    ...
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_gephaltung_insert();
...
CREATE TRIGGER on_gephaltung_update
    ...
    ON tww_app.vw_agxx_gephaltung
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_gephaltung_update();
...
CREATE TRIGGER on_gephaltung_delete
    ...
    ON tww_app.vw_agxx_gephaltung
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_gephaltung_delete();
...
CREATE TRIGGER on_gepmassnahme_upsert
    ...
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_gepmassnahme_upsert();
...
CREATE TRIGGER on_gepmassnahme_delete
    ...
    ON tww_app.vw_agxx_gepmassnahme
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_gepmassnahme_delete();
...
CREATE TRIGGER on_einzugsgebiet_upsert
    ...
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_einzugsgebiet_upsert();
...
CREATE TRIGGER on_einzugsgebiet_delete
    ...
    ON tww_app.vw_agxx_einzugsgebiet
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_einzugsgebiet_delete();
...
CREATE TRIGGER on_ueberlauf_foerderaggregat_insert
    ...
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_ueberlauf_foerderaggregat_insert();
...
CREATE TRIGGER on_ueberlauf_foerderaggregat_update
    ...
    ON tww_app.vw_agxx_ueberlauf_foerderaggregat
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_ueberlauf_foerderaggregat_update();
...
CREATE TRIGGER on_ueberlauf_foerderaggregat_delete
    ...
    ON tww_app.vw_agxx_ueberlauf_foerderaggregat
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_ueberlauf_foerderaggregat_delete();
...
CREATE TRIGGER on_bautenausserhalbbaugebiet_upsert
    ...
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_bautenausserhalbbaugebiet_upsert();
...
CREATE TRIGGER on_bautenausserhalbbaugebiet_delete
    ...
    ON tww_app.vw_agxx_bautenausserhalbbaugebiet
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_bautenausserhalbbaugebiet_delete();
...
CREATE TRIGGER on_sbw_einzugsgebiet_upsert
    ...
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_sbw_einzugsgebiet_upsert();
...
CREATE TRIGGER on_sbw_einzugsgebiet_delete
    ...
    ON tww_app.vw_agxx_sbw_einzugsgebiet
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_sbw_einzugsgebiet_delete();
...
CREATE TRIGGER on_versickerungsbereichag_insert
    ...
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_versickerungsbereichag_insert();
...
CREATE TRIGGER on_versickerungsbereichag_update
    ...
    ON tww_app.vw_agxx_versickerungsbereichag
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_versickerungsbereichag_update();
...
CREATE TRIGGER on_versickerungsbereichag_delete
    ...
    ON tww_app.vw_agxx_versickerungsbereichag
    FOR EACH ROW
    EXECUTE FUNCTION tww_app.ft_agxx_ft_versickerungsbereichag_delete();
