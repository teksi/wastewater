...
SET 
	...
	, sewer_infiltration_water = q_inf_current
	...
	, waste_water_production = q_ww_current
	, ag96_sewer_infiltration_water_dim = q_inf_dim
	, ag96_waste_water_production_dim = q_ww_dim
FROM
( SELECT cat.obj_id
	...
	, SUM(q_inf_dim) as q_inf_dim
	, SUM(q_ww_dim) as q_ww_dim
   FROM ca
