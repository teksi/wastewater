...
CREATE OR REPLACE VIEW tww_app.swmm_vw_dwf AS
SELECT
	CASE
...
FROM
(
SELECT ca.*,'current' as state, 'rw_current' as type_ca, wn.obj_id as wn_obj_id, cfhi.vsacode AS _function_hierarchic
