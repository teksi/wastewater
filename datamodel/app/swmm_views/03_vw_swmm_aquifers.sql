--------
-- View for the swmm module class aquifer (in qgep wrongly named aquifier), in VSA-DSS 2020 not part of the datamodel anymore - therefore referenced on tww_od.dss15_aquifer
--------
