...
--------
CREATE OR REPLACE VIEW tww_app.vw_reservoir AS
...
CREATE OR REPLACE FUNCTION tww_app.vw_reservoir_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_reservoir_ON_INSERT INSTEAD OF INSERT ON tww_app.vw_reservoir
  FOR EACH ROW EXECUTE PROCEDURE tww_app.vw_reservoir_insert();
...
CREATE OR REPLACE RULE vw_reservoir_ON_UPDATE AS ON UPDATE TO tww_app.vw_reservoir DO INSTEAD (
...
CREATE OR REPLACE RULE vw_reservoir_ON_DELETE AS ON DELETE TO tww_app.vw_reservoir DO INSTEAD (
