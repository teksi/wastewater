...
CREATE OR REPLACE FUNCTION tww_app.vw_wizard_reach_channel_INSERT()
  RETURNS trigger AS
$BODY$
DECLARE
  ch_obj_id character varying(16);
BEGIN
  INSERT INTO tww_app.vw_channel(
         bedding_encasement
       , connection_type
       , function_hierarchic
       , function_hydraulic
...
DROP TRIGGER IF EXISTS vw_wizard_reach_channel_ON_INSERT ON tww_app.vw_wizard_reach_channel;
