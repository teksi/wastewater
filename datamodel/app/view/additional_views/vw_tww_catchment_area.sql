...
CREATE OR REPLACE FUNCTION tww_app.vw_tww_catchment_area_insert()
  RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER vw_tww_catchment_area_ON_INSERT INSTEAD OF INSERT ON tww_app.vw_tww_catchment_area
  FOR EACH ROW EXECUTE PROCEDURE tww_app.vw_tww_catchment_area_insert();
...
CREATE OR REPLACE RULE vw_tww_catchment_area_ON_UPDATE AS ON UPDATE TO tww_app.vw_tww_catchment_area DO INSTEAD (
...
CREATE OR REPLACE RULE vw_tww_catchment_area_ON_DELETE AS ON DELETE TO tww_app.vw_tww_catchment_area DO
INSTEAD (
