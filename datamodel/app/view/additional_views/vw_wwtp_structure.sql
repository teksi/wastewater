...
--------
CREATE OR REPLACE VIEW tww_app.vw_wwtp_structure AS
...
CREATE TRIGGER vw_wwtp_structure_ON_INSERT INSTEAD OF INSERT ON tww_app.vw_wwtp_structure
  FOR EACH ROW EXECUTE PROCEDURE tww_app.vw_wwtp_structure_insert();
...
CREATE OR REPLACE RULE vw_wwtp_structure_ON_UPDATE AS ON UPDATE TO tww_app.vw_wwtp_structure DO INSTEAD (
...
CREATE OR REPLACE RULE vw_wwtp_structure_ON_DELETE AS ON DELETE TO tww_app.vw_wwtp_structure DO INSTEAD (
