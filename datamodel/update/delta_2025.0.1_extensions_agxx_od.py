        ...
        with conn.cursor() as cursor:
            ...
            if cursor.fetchone():
                ...
                for key in agxx_defs:
                    query.append(
                        f"""INSERT INTO tww_od.agxx_{key}(obj_id, {', '.join(agxx_defs[key])})
                ...
                for key in modification_defs:
                    query.append(
                        f"""INSERT INTO tww_od.agxx_last_modification(obj_id, ag64_last_modification, ag96_last_modification)
