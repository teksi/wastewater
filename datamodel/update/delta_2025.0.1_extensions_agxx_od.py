    ...
    def migrate_agxx_data(self):
        ...
        with conn.cursor() as cursor:
            ...
            if cursor.rowcount()>0:
                ...
                "reach":['ag96_is_gateway','ag64_function'],
                ...
                "overflow":['ag96_fk_provider','ag96_remark','ag64_fk_provider','ag64_last_modification','ag64_remark'],
                ...
                for key in agxx_defs:
                    ...
                    for val in agxx_defs[key]:
                        query.append(f"ALTER TABLE tww_od.{key} DROP COLUMN {val};")
                cursor.execute('\n'.join(query))
