...
--------
CREATE OR REPLACE VIEW tww_swmm.vw_storages AS
...
WHERE ssf.vsacode IN ( -- must be the same list in vw_swmm_junctions
...
LEFT JOIN tww_vl.infiltration_installation_kind iik on ii.kind = iik.code
