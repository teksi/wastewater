...
SELECT
	wn.obj_id as Name,
	coalesce(wn.bottom_level,0) as InvertElev,
	coalesce((wn.backflow_level_current-wn.bottom_level_current),0) as MaxDepth,
	0 as InitDepth,
	'FUNCTIONAL' as Shape,
...
AND oc.kind_overflow_char = 6220; -- h/q relations (Q/Q relations are not supported by SWMM) 
