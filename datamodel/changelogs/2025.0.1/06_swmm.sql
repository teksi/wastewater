...
ALTER TABLE tww_cfg.reach_coefficient_of_friction ADD CONSTRAINT pkey_tww_vl_reach_coefficient_of_friction_id PRIMARY KEY (fk_material);
INSERT INTO tww_cfg.reach_coefficient_of_friction(fk_material) SELECT vsacode FROM tww_vl.reach_material;
UPDATE tww_cfg.reach_coefficient_of_friction SET coefficient_of_friction = (CASE WHEN fk_material IN (5381,5081,3016) THEN 100
