...
(
   ...
   CONSTRAINT pkey_tww_od_sia405cc_cable_point_obj_id PRIMARY KEY (obj_id)
)
WITH (
   OIDS = False
);
...
COMMENT ON COLUMN tww_od.sia405cc_cable_point.kind IS '';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN horizontal_positioning  integer ;
COMMENT ON COLUMN tww_od.sia405cc_cable_point.horizontal_positioning IS '';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN altitude  decimal(7,3) ;
COMMENT ON COLUMN tww_od.sia405cc_cable_point.altitude IS '';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN elevation_determination  integer ;
COMMENT ON COLUMN tww_od.sia405cc_cable_point.elevation_determination IS '';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN status  integer ;
COMMENT ON COLUMN tww_od.sia405cc_cable_point.status IS 'Operating and planning status of the structure / Betriebs- bzw. Planungszustand des Bauwerks / Etat de fonctionnement et de planification de l’ouvrage';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN installation_year  smallint ;
COMMENT ON COLUMN tww_od.sia405cc_cable_point.installation_year IS '';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN sur_plus_cover  decimal(4,1) ;
COMMENT ON COLUMN tww_od.sia405cc_cable_point.sur_plus_cover IS '';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN condition text;
 ALTER TABLE tww_od.sia405cc_cable_point ADD CONSTRAINT _condition_length_max_40 CHECK(char_length(condition)<=40);
COMMENT ON COLUMN tww_od.sia405cc_cable_point.condition IS '';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN remark text;
 ALTER TABLE tww_od.sia405cc_cable_point ADD CONSTRAINT _remark_length_max_80 CHECK(char_length(remark)<=80);
COMMENT ON COLUMN tww_od.sia405cc_cable_point.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN dimension1  smallint ;
COMMENT ON COLUMN tww_od.sia405cc_cable_point.dimension1 IS '';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN dimension2  smallint ;
...
COMMENT ON COLUMN tww_od.sia405cc_cable_point.last_modification IS 'Last modification / Letzte_Aenderung / Derniere_modification: INTERLIS_1_DATE';
 ALTER TABLE tww_od.sia405cc_cable_point ADD COLUMN fk_dataowner varchar(16);
...
-------
-------
CREATE TABLE tww_od.sia405cc_cable
(
   obj_id varchar(16) NOT NULL,
   CONSTRAINT pkey_tww_od_sia405cc_cable_obj_id PRIMARY KEY (obj_id)
)
WITH (
   OIDS = False
);
...
COMMENT ON COLUMN tww_od.sia405cc_cable.function IS '';
 ALTER TABLE tww_od.sia405cc_cable ADD COLUMN cable_type  integer ;
COMMENT ON COLUMN tww_od.sia405cc_cable.cable_type IS 'Cable type / Kabelart / Genre de cable';
 ALTER TABLE tww_od.sia405cc_cable ADD COLUMN horizontal_positioning  integer ;
COMMENT ON COLUMN tww_od.sia405cc_cable.horizontal_positioning IS '';
 ALTER TABLE tww_od.sia405cc_cable ADD COLUMN status  integer ;
COMMENT ON COLUMN tww_od.sia405cc_cable.status IS '';
 ALTER TABLE tww_od.sia405cc_cable ADD COLUMN installation_year  smallint ;
COMMENT ON COLUMN tww_od.sia405cc_cable.installation_year IS '';
 ALTER TABLE tww_od.sia405cc_cable ADD COLUMN sur_plus_cover  decimal(4,1) ;
COMMENT ON COLUMN tww_od.sia405cc_cable.sur_plus_cover IS '';
 ALTER TABLE tww_od.sia405cc_cable ADD COLUMN condition text;
 ALTER TABLE tww_od.sia405cc_cable ADD CONSTRAINT _condition_length_max_40 CHECK(char_length(condition)<=40);
COMMENT ON COLUMN tww_od.sia405cc_cable.condition IS '';
 ALTER TABLE tww_od.sia405cc_cable ADD COLUMN remark text;
 ALTER TABLE tww_od.sia405cc_cable ADD CONSTRAINT _remark_length_max_80 CHECK(char_length(remark)<=80);
