...
--- Adapt tww_vl.organisation_organisation_type
 ...
 UPDATE tww_vl.organisation_organisation_type SET
   ...
   description_ro = 'Asociație de apa uzata sau alta forma de organizație intercomunala de drept public.',
...
--- Adapt tww_vl.organisation_organisation_type
 ...
 UPDATE tww_vl.organisation_organisation_type SET
   ...
   description_ro = 'Parte a unei administrații municipale care îți asuma un rol ((de exemplu, Geoinformation Stadt Bern) ca sponsor, furnizor de date etc. (dar nu ca proprietar de date / proprietar (public)).',
...
--- Adapt tww_vl.organisation_organisation_type
 ...
 UPDATE tww_vl.organisation_organisation_type SET
   ...
   description_ro = 'Cooperativa, corporație sau alta forma de organizație municipala de drept public. Daca este de drept privat, indicați „Privat”.',
...
--- Adapt tww_vl.wastewater_structure_accessibility
 ...
 UPDATE tww_vl.wastewater_structure_accessibility SET
   ...
   description_ro = 'Aici, de exemplu, trebuie sa sapi mai întâi pâna când poți deschide capacul.',
   display_en = 'covered',
...
--- Adapt tww_vl.wastewater_structure_accessibility
 ...
 UPDATE tww_vl.wastewater_structure_accessibility SET
   ...
   description_ro = 'Nu exista acces liber - barierele trebuie îndepartate, autorizațiile de acces trebuie solicitate în prealabil, sunt necesare chei etc.',
...
--- Adapt tww_vl.wastewater_structure_accessibility
 ...
 UPDATE tww_vl.wastewater_structure_accessibility SET
   ...
   description_ro = 'Disponibil pentru o persoana (ți nu neaparat un vehicul)',
...
--- Adapt tww_vl.wastewater_structure_status
 ...
 UPDATE tww_vl.wastewater_structure_status SET
   ...
   description_ro = 'Dupa ce instalația a fost pusa în funcțiune',
...
--- Adapt tww_vl.wastewater_structure_structure_condition
 ...
 UPDATE tww_vl.wastewater_structure_structure_condition SET
   ...
   description_ro = 'Defecte grave. Defecte structurale ce nu mai garanteaza securitatea statica, hidraulica sau etanseitatea: rupturi, deformații axiale sau radiale,(teava), patrunderea apei sau apa scurgeri ale apei vizibile, gauri în perete',
   display_en = 'Z1',
   display_de = 'Z1',
   display_fr = 'Z1',
   display_it = '',
...
--- Adapt tww_vl.wastewater_structure_structure_condition
 ...
 UPDATE tww_vl.wastewater_structure_structure_condition SET
   ...
   description_ro = 'Defecte medii. Defecte structurale ce afecteaza statica, hidraulica sau etanseitatea: fisuri, îmbinari problematice, intrari necurațate, mici obstacole în calea apei, calcificari, daune usoare în perete',
   display_en = 'Z2',
   display_de = 'Z2',
   display_fr = 'Z2',
   display_it = '',
...
--- Adapt tww_vl.manhole_function
 ...
 UPDATE tww_vl.manhole_function SET
   ...
   description_ro = 'rrr_Structura speciala pentru separarea fluidelor uțoare de apa. Acesta previne patrunderea uleiurilor in mediile receptoare.',
...
--- Adapt tww_vl.special_structure_function
 ...
 UPDATE tww_vl.special_structure_function SET
   ...
   description_fr = 'Ouvrage spécial dans le réseau de canalisations servant à relier des différences d''altitude sur une petite distance, en brisant l''énergie de l''écoulement.',
   description_it = 'zzz_Ein Absturzschacht ist ein spezielles Bauwerk im Kanalisationsnetz zur Überwindung von Höhenunterschieden auf kurze Entfernung bei gleichzeitiger Energieumwandlung',
   description_ro = 'Structura speciala în rețeaua de canalizare care serveste la normalizarea diferențelor de altitudine pe o distanța mica, la ruperea de energie a debitului.',
   display_en = 'drop_structure',
   display_de = 'Absturzbauwerk',
   display_fr = 'ouvrage de chute',
   display_it = '',
...
--- Adapt tww_vl.special_structure_function
 ...
 UPDATE tww_vl.special_structure_function SET
   ...
   description_ro = 'Depresiune de teren artificiala sau naturala, cu funcție de retentie',
...
--- Adapt tww_vl.special_structure_function
 ...
 UPDATE tww_vl.special_structure_function SET
   ...
   description_ro = 'Instalatie de retea de ape mixte ce serveste la decantarea solidelor ți stocarea apelor mixte (ca funcție secundara are stocarea de ape pluviale minime).',
...
--- Adapt tww_vl.special_structure_function
 ...
 UPDATE tww_vl.special_structure_function SET
   ...
   description_ro = 'Canalizare de stocare cu acelați mod de operare ca bazinul de stocare apa meteorica',
...
--- Adapt tww_vl.special_structure_function
 ...
 UPDATE tww_vl.special_structure_function SET
   ...
   description_ro = 'Instalatie pentru scurgerea apei nedaunatoare pe o înalțime data. Instalatia este compusa din: camera in forma de vortex, conducta picurare ți din o conducta de aerisire',
...
--- Adapt tww_vl.special_structure_stormwater_tank_arrangement
 ...
 UPDATE tww_vl.special_structure_stormwater_tank_arrangement SET
   ...
   description_ro = 'Conectarea care permite trecerea continua a apelor pe timp uscat si o porțiune a apei pe timp ploios',
...
--- Adapt tww_vl.log_card_control_remote_control
 ...
 UPDATE tww_vl.log_card_control_remote_control SET
   ...
   description_ro = 'Fara transmisie/alarmare de la distanța',
...
--- Adapt tww_vl.log_card_control_remote_control
 ...
 UPDATE tww_vl.log_card_control_remote_control SET
   ...
   description_ro = 'Necesita control local. Alarmele sunt transmise, dar nu ți alte semnale',
...
--- Adapt tww_vl.log_card_control_remote_control
 ...
 UPDATE tww_vl.log_card_control_remote_control SET
   ...
   description_ro = 'Necesita control local. În plus fața de alarme, sunt transmise ți alte date de masurare, de obicei catre un sistem de control al procesului (SCP).',
...
--- Adapt tww_vl.log_card_control_remote_control
 ...
 UPDATE tww_vl.log_card_control_remote_control SET
   ...
   description_ro = 'Necesita control local. În plus fața de alarme, alte date de masurare sunt, de asemenea, transmise catre un sistem de control al procesului (SCP). SCP poate trimite, de asemenea, semnale de control sau de stare catre cladire în scopul controlului interconectat.',
...
--- Adapt tww_vl.bio_ecol_assessment_intervention_demand
 ...
 UPDATE tww_vl.bio_ecol_assessment_intervention_demand SET
   ...
   description_ro = 'Influența mare a punctului de deversare din cauza investigației, prin urmare este nevoie de masuri pe termen scurt.',
...
--- Adapt tww_vl.bio_ecol_assessment_intervention_demand
 ...
 UPDATE tww_vl.bio_ecol_assessment_intervention_demand SET
   ...
   description_ro = 'Impactul mediu al punctului de deversare pe baza investigației, prin urmare este nevoie de masuri pe termen lung.',
...
--- Adapt tww_vl.bio_ecol_assessment_intervention_demand
 ...
 UPDATE tww_vl.bio_ecol_assessment_intervention_demand SET
   ...
   description_ro = 'Din cauza circumstanțelor, ancheta nu permite nicio declarație privind influența punctului de deversare asupra corpului de apa. O investigație suplimentara a apei nu a putut furniza constatari suplimentare.',
   display_en = 'no_conclusion_possible',
   display_de = 'keine_Aussage_moeglich',
   display_fr = 'aucun avis possible',
   display_it = '',
...
--- Adapt tww_vl.bio_ecol_assessment_intervention_demand
 ...
 UPDATE tww_vl.bio_ecol_assessment_intervention_demand SET
   ...
   description_ro = 'Nu exista nicio influența a punctului de deversare pe baza investigației, prin urmare nu este necesara nicio acțiune.',
   display_en = 'no',
   display_de = 'nein',
   display_fr = 'non',
   display_it = '',
...
--- Adapt tww_vl.bio_ecol_assessment_intervention_demand
 ...
 UPDATE tww_vl.bio_ecol_assessment_intervention_demand SET
   ...
   description_ro = 'Rezultatele anchetei au fost neclare. Sunt ațteptate alte constatari în urma unei investigații reînnoite / mai ample a cursului de apa.',
