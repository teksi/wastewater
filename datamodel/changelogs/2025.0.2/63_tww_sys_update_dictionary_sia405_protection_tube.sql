...
UPDATE tww_sys.dictionary_od_table SET 
   ...
   name_de = 'Schutzrohr',
   shortcut_de = 'PT',
   name_fr = 'tube de protection',
   shortcut_fr = 'TP',
   name_it = 'pozzetto termico',
   shortcut_it = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405pt_protection_tube',
   field_name = 'material',
   field_name_en = 'material',
   field_name_de = 'Material',
   field_name_fr = 'Materiau',
   field_name_it = 'materiale',
   field_name_ro = 'material',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405pt_protection_tube',
   field_name = 'nominal_diameter',
   field_name_en = 'nominal_diameter',
   field_name_de = 'Nennweite',
   field_name_fr = 'Largeur_nominale',
   field_name_it = 'larghezza_nominale',
   field_name_ro = 'diametrul_nominal',
   field_description_en = 'as TEXT, as in some cases double values with slash (eg. 1500/800)',
   field_description_de = 'als TEXT, da zum Teil auch Doppelwerte mit Schrägstrich (z.B. 1500/800)',
   field_description_fr = 'comme TEXTE, parcequ''on a aussi des valeurs doubles (par example 1500/800)',
   field_description_it = 'come TESTO, poiché in alcuni casi i valori sono doppi con la barra (es. 1500/800).',
   field_description_ro = 'ca TEXT, deoarece în unele cazuri se dubleaza valorile cu o bara oblica (de exemplu, 1500/800)',
   field_mandatory = ARRAY['Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'varchar(10)',
   field_unit_en = '',
   field_unit_description_en = 'as TEXT, because sometimes also double values with slash inbetween eg. 500/800',
   field_unit_de = '',
   field_unit_description_de = 'als TEXT, da zum Teil auch Doppelwerte mit Schrägstrich (1500/1000)',
   field_unit_fr = '',
   field_unit_description_fr = 'En tant que TEXT, car peut contenir des valeurs doubles avec barre oblique (1500/1000)',
   field_unit_it = '',
   field_unit_description_it = 'come TESTO, poiché in alcuni casi valori doppi con slash (1500/1000)',
   field_unit_ro = '',
   field_unit_description_ro = 'rrr_als TEXT, da zum Teil auch Doppelwerte mit Schrägstrich (1500/1000)',
   field_max = NULL,
   field_min = NULL
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_en = 'outside_diameter',
   field_name_de = 'Aussendurchmesser',
   field_name_fr = 'Diametre_exterieur',
   field_name_it = 'diametro_esterno',
   field_name_ro = 'diametrul_exterior',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
   ...
   field_unit_fr = '[mm]',
   field_unit_description_fr = 'milimétre [mm]',
   field_unit_it = '[mm]',
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405pt_protection_tube',
   field_name = 'lenght',
   field_name_en = 'lenght',
   field_name_de = 'Laenge',
   field_name_fr = 'Longeur',
   field_name_it = 'lunghezza',
   field_name_ro = 'lungime',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_fr = 'Couverture',
   field_name_it = 'zzz_Ueberdeckung',
   field_name_ro = '',
   field_description_en = 'yyy_mittlerer Wert eines Objektes',
   field_description_de = 'mittlerer Wert eines Objektes',
   field_description_fr = 'xxx_mittlerer Wert eines Objektes',
   field_description_it = 'zzz_mittlerer Wert eines Objektes',
   field_description_ro = 'rrr_mittlerer Wert eines Objektes',
   field_mandatory = ARRAY['Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
...
UPDATE tww_sys.dictionary_od_values SET 
   ...
   value_name_en = 'plastic.polyethylene',
   shortcut_en = '',
   value_name_de = 'Kunststoff.Polyethylen',
   shortcut_de = '',
   value_name_fr = 'matiere_synthetique.polyethylene',
   shortcut_fr = '',
   value_name_it = 'materiale_sintetico.polietilene',
   shortcut_it = '',
   value_name_ro = '',
   shortcut_ro = '',
   value_description_en = '',
...
UPDATE tww_sys.dictionary_od_values SET 
   ...
   value_name_en = 'plastic.PVC',
   shortcut_en = '',
   value_name_de = 'Kunststoff.Polyvinylchlorid',
   shortcut_de = '',
   value_name_fr = 'matiere_synthetique.chlorure_de_polyvinyle',
   shortcut_fr = '',
   value_name_it = 'materiale_sintetico.polivinilcloruro',
   shortcut_it = '',
   value_name_ro = '',
   shortcut_ro = '',
   value_description_en = '',
...
UPDATE tww_sys.dictionary_od_values SET 
   ...
   shortcut_en = '',
   value_name_de = 'Guss.Guss_duktil',
   shortcut_de = '',
   value_name_fr = 'fonte.fonte_ductil',
   shortcut_fr = '',
   value_name_it = 'ghisa.ghisa_duttile',
   shortcut_it = '',
   value_name_ro = 'fonta.fonta_ductila',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET 
   ...
   value_name_en = 'cast_iron.gray_iron',
   shortcut_en = '',
   value_name_de = 'Guss.Grauguss',
   shortcut_de = '',
   value_name_fr = 'fonte.fonte_grise',
   shortcut_fr = '',
   value_name_it = 'ghisa.ghisa_grigia',
   shortcut_it = '',
   value_name_ro = 'fonta.fonta_cenusie',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET 
   ...
   field_name = 'material',
   value_name = 'concrete',
   value_name_en = 'concrete',
   shortcut_en = '',
   value_name_de = 'Beton',
   shortcut_de = '',
   value_name_fr = 'beton',
   shortcut_fr = '',
   value_name_it = 'calcestruzzo',
   shortcut_it = '',
   value_name_ro = 'beton',
   shortcut_ro = '',
   value_description_en = '',
