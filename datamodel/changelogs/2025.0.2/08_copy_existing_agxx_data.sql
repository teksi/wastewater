...
BEGIN
    IF EXISTS (
        ...
        INSERT INTO tww_od.agxx_wastewater_node(fk_wastewater_node, ag96_is_gateway, ag64_function)
        ...
        INSERT INTO tww_od.agxx_cover(fk_cover, ag64_fk_wastewater_node)
        SELECT obj_id, ag64_fk_wastewater_node
        FROM tww_od.cover;

        ALTER TABLE tww_od.cover DROP COLUMN ag64_fk_wastewater_node CASCADE;

        INSERT INTO tww_od.agxx_wastewater_structure(fk_wastewater_structure, ag96_fk_measure)
        ...
        INSERT INTO tww_od.agxx_reach(fk_reach, ag96_clear_height_planned, ag96_clear_width_planned)
        ...
        INSERT INTO tww_od.agxx_catchment_area_totals(fk_catchment_area_totals, ag96_sewer_infiltration_water_dim, ag96_waste_water_production_dim, ag96_perimeter_geometry)
        ...
        INSERT INTO tww_od.agxx_building_group(fk_building_group, ag96_owner_address, ag96_owner_name, ag96_label_number, ag96_disposal_wastewater, ag96_disposal_industrial_wastewater, ag96_disposal_square_water, ag96_disposal_roof_water, ag96_population)
        ...
        INSERT INTO tww_od.agxx_wastewater_networkelement(fk_wastewater_networkelement, ag96_fk_provider, ag96_remark, ag64_fk_provider, ag64_remark)
        ...
        INSERT INTO tww_od.agxx_overflow(fk_overflow, ag96_fk_provider, ag96_remark, ag64_fk_provider, ag64_remark)
        SELECT obj_id, ag96_fk_provider, ag96_remark, ag64_fk_provider, ag64_remark
        ...
        INSERT INTO tww_od.agxx_infiltration_zone(fk_infiltration_zone, ag96_permeability, ag96_limitation, ag96_thickness, ag96_q_check)
        ...
        INSERT INTO tww_od.agxx_last_modification(fk_element, ag64_last_modification, ag96_last_modification)
