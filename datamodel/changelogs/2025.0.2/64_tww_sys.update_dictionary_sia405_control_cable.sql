...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name = 'name_number',
   field_name_en = 'name_number',
   field_name_de = 'Name_Nummer',
   field_name_fr = 'Nom_numero',
   field_name_it = 'nome_numero',
   field_name_ro = 'nume_numarul',
   field_description_en = '',
   field_description_de = 'z.B. Kabelpunktanfang_Kabelpunkteende',
   field_description_fr = 'xxx_z.B. Point_cableanfang_Point_cableeende',
   field_description_it = '',
   field_description_ro = '',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405cc_cable',
   field_name = 'geometry',
   field_name_en = 'geometry',
   field_name_de = 'Geometrie',
   field_name_fr = 'Geometrie',
   field_name_it = 'geometria',
   field_name_ro = 'geometria',
   field_description_en = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405cc_cable',
   field_name = 'function',
   field_name_en = 'function',
   field_name_de = 'Funktion',
   field_name_fr = 'Fonction',
   field_name_it = 'zzz_Funktion',
   field_name_ro = 'zzz_Funktion',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
   field_description_ro = '',
   field_mandatory = ARRAY['Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_en = 'cable_type',
   field_name_de = 'Kabelart',
   field_name_fr = 'Genre',
   field_name_it = 'zzz_Kabelart',
   field_name_ro = '',
   field_description_en = 'Cable type',
   field_description_de = 'Kabelart',
   field_description_fr = 'Genre de cable',
   field_description_it = 'zzz_Kabelart',
   field_description_ro = 'rrr_Kabelart',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'integer',
   field_unit_en = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_en = 'horizontal_positioning',
   field_name_de = 'Lagebestimmung',
   field_name_fr = 'Determination_planimetrique',
   field_name_it = 'determinazione_posizione',
   field_name_ro = 'precizie_pozitie',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_datatype = 'integer',
   field_unit_en = '',
   field_unit_description_en = 'extends value range of SIA405 status',
   field_unit_de = '',
   field_unit_description_de = 'Erweitert Wertebereich von SIA405 Status',
   field_unit_fr = '',
   field_unit_description_fr = 'extension valeurs SIA405 Etat',
   field_unit_it = '',
   field_unit_description_it = 'dilatato codominio SIA405 Stato',
   field_unit_ro = '',
   field_unit_description_ro = 'rrr_Erweitert Wertebereich von SIA405 Status',
   field_max = NULL,
   field_min = NULL
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_en = 'installation_year',
   field_name_de = 'Einbaujahr',
   field_name_fr = 'Annee_construction',
   field_name_it = 'anno_costruzione',
   field_name_ro = 'anul_instalarii',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
   ...
   field_unit_en = '',
   field_unit_description_en = ' If unknown set lowest value of value range',
   field_unit_de = '',
   field_unit_description_de = 'Falls unbekannt, tiefsten Wert des Wertebereichs einsetzen',
   field_unit_fr = '',
   field_unit_description_fr = 'Si inconnu ajouter la plus bas valeur du domaine des valeurs',
   field_unit_it = '',
   field_unit_description_it = 'Se sconosciuto, inserire valore minimo dell’intervallo di valori',
   field_unit_ro = '',
   field_unit_description_ro = 'rrr_Falls unbekannt, tiefsten Wert des Wertebereichs einsetzen',
   field_max = 2100,
   field_min = 1800
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405cc_cable',
   field_name = 'sur_plus_cover',
   field_name_en = 'sur_plus_cover',
   field_name_de = 'Ueberdeckung',
   field_name_fr = 'Couverture_ouvrage',
   field_name_it = 'zzz_Ueberdeckung',
   field_name_ro = 'zzz_Ueberdeckung',
   field_description_en = 'Numerical mean value of an object',
   field_description_de = 'Numerisch mittlerer Wert eines Objektes',
   field_description_fr = 'Valeur moyenne d''''un objet',
   field_description_it = 'Valore medio numerico di un oggetto',
   field_description_ro = 'Valoarea medie numerica a unui obiect',
   field_mandatory = ARRAY['Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'decimal(4,1)',
   field_unit_en = '[m]',
   field_unit_description_en = 'meter [m]',
   field_unit_de = '[m]',
   field_unit_description_de = 'Meter [m]',
   field_unit_fr = '[m]',
   field_unit_description_fr = 'mètre [m]',
   field_unit_it = '[m]',
   field_unit_description_it = 'metro [m]',
   field_unit_ro = '[m]',
   field_unit_description_ro = 'rrr_Meter [m]',
   field_max = 999.9,
   field_min = 0
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_de = 'Zustand',
   field_name_fr = 'Condition',
   field_name_it = 'condizione',
   field_name_ro = 'zzz_Zustand',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name = 'width',
   field_name_en = 'width',
   field_name_de = 'Breite',
   field_name_fr = 'Largeur',
   field_name_it = 'larghezza',
   field_name_ro = 'latime',
   field_description_en = 'Width of cable trench',
   field_description_de = 'Breite Kabeltrasse',
   field_description_fr = 'Largeur du tracé du câble',
   field_description_it = 'zzz_Breite Kabeltrasse',
   field_description_ro = 'rrr_Breite Kabeltrasse',
   field_mandatory = ARRAY['Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'smallint',
   field_unit_en = '[mm]',
   field_unit_description_en = 'millimeter [mm]',
   field_unit_de = '[mm]',
   field_unit_description_de = 'Millimeter [mm]',
   field_unit_fr = '[mm]',
   field_unit_description_fr = 'milimètre [mm]',
   field_unit_it = '[mm]',
   field_unit_description_it = '	millimetro [mm]',
   field_unit_ro = '[mm]',
   field_unit_description_ro = 'rrr_Millimeter [mm]',
   field_max = 4000,
   field_min = 0
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405cc_cable',
   field_name = 'geometry3d',
   field_name_en = 'geometry3d',
   field_name_de = 'Geometrie3D',
   field_name_fr = 'Geometrie3D',
   field_name_it = 'geometria3d',
   field_name_ro = 'geometria3D',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_en = 'elevation_determination',
   field_name_de = 'Hoehenbestimmung',
   field_name_fr = 'Determination_altimetrique',
   field_name_it = 'determinazione_dell_altezza',
   field_name_ro = 'determinare_altimetrica',
   field_description_en = '',
   field_description_de = '',
   field_description_fr = '',
   field_description_it = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name = 'depth',
   field_name_en = 'depth',
   field_name_de = 'Maechtigkeit',
   field_name_fr = 'Epaisseur',
   field_name_it = 'spessore',
   field_name_ro = 'adancime',
   field_description_en = 'Extension 3D, heigth of of cable trench [mm].',
   field_description_de = 'Erweiterung 3D, Mächtigkeit (Höhe) Kabeltrasse [mm].',
   field_description_fr = 'Extension 3D, épaisseur (largeur) du trace du câble [mm].',
   field_description_it = 'zzz_Erweiterung 3D, Mächtigkeit (Höhe) Kabeltrasse [mm].',
   field_description_ro = 'rrr_Erweiterung 3D, Mächtigkeit (Höhe) Kabeltrasse [mm].',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'smallint',
   field_unit_en = '[mm]',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_visible = 'true',
   field_datatype = 'geometry',
   field_unit_en = '[NCoord]',
   field_unit_description_en = 'Swiss national grid coordinates',
   field_unit_de = '[LKoord]',
   field_unit_description_de = 'Schweizer Landeskoordinaten',
   field_unit_fr = '[CoordNat]',
   field_unit_description_fr = 'coordonnées dans le système de coordonnées suisse',
   field_unit_it = '[CoordNaz]',
   field_unit_description_it = 'Coordinate nazionali Svizzera',
   field_unit_ro = 'rrr_[LKoord]',
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405cc_cable_point',
   field_name = 'altitude',
   field_name_en = 'altitude',
   field_name_de = 'Hoehe',
   field_name_fr = 'Altitude',
   field_name_it = 'livello',
   field_name_ro = 'altitudine',
   field_description_en = 'Altitude of component',
   field_description_de = 'Oberkante Bauteil',
   field_description_fr = 'Bord supérieur de l''élément contructif',
   field_description_it = 'Bordo superiore del componente',
   field_description_ro = 'Marginea superioara a componentei',
   field_mandatory = ARRAY['Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_it = 'determinazione_dell_altezza',
   field_name_ro = 'determinare_altimetrica',
   field_description_en = 'Elevation determination of geometry (3D)',
   field_description_de = 'Höhenbestimmung der Geometrie (3D)',
   field_description_fr = 'Définition de la détermination altimétrique de la Géométrie (3D)',
   field_description_it = 'Determinazione dell''altezza della geometria (3D)',
   field_description_ro = 'Determinarea altimetrica geometriei (3D)',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'integer',
   field_unit_en = '',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_it = 'stato',
   field_name_ro = 'stare',
   field_description_en = 'Operating and planning status of the structure',
   field_description_de = 'Betriebs- bzw. Planungszustand des Bauwerks',
   field_description_fr = 'Etat de fonctionnement et de planification de l’ouvrage',
   field_description_it = 'Stato di funzionamento e di pianificazione del manufatto.',
   field_description_ro = '',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'integer',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_en = 'dimension1',
   field_name_de = 'Dimension1',
   field_name_fr = 'Dimension1',
   field_name_it = 'dimensione1',
   field_name_ro = 'dimensiune1',
   field_description_en = 'Larger dimension of an object (e.g. length)',
   field_description_de = 'grösseres Mass eines Objektes (z.B. Länge)',
   field_description_fr = 'plus grande mesure d''un objet (par ex. Longueur, diamètre)',
   field_description_it = 'Dimensione maggiore di un oggetto (ad es. lunghezza)',
   field_description_ro = 'Dimensiunea mai mare a unui obiect (de exemplu, lungimea)',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'smallint',
   field_unit_en = '[mm]',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_en = 'dimension2',
   field_name_de = 'Dimension2',
   field_name_fr = 'Dimension2',
   field_name_it = 'dimensione2',
   field_name_ro = 'dimenisune2',
   field_description_en = 'smaller dimension of an object (e.g. width)',
   field_description_de = 'kleineres Mass eines Objektes (z.B. Breite)',
   field_description_fr = 'plus petite msure d''un objet (par ex. Largeur)',
   field_description_it = 'dimensione minore di un oggetto (ad es. larghezza)',
   field_description_ro = 'dimensiunea mai mica a unui obiect (de exemplu, la?imea)',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'smallint',
   field_unit_en = '[mm]',
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405cc_cable_point',
   field_name = 'altitude_lower_edge',
   field_name_en = 'altitude_lower_edge',
   field_name_de = 'Hoehe_UK',
   field_name_fr = 'Altitude_BI',
   field_name_it = 'zzz_livello_bordo_inferiore',
   field_name_ro = 'rrr_Hoehe_UK',
   field_description_en = 'Altitude lower edge of component',
   field_description_de = 'Höhe Unterkante',
   field_description_fr = 'Bord inférieur de l''élément constructif',
   field_description_it = 'Bordo inferiore del componente',
   field_description_ro = 'Marginea inferioara a componentei',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'decimal(7,3)',
   field_unit_en = '[m.a.sl.]',
...
UPDATE tww_sys.dictionary_od_field  SET
   table_name = 'sia405cc_cable_point',
   field_name = 'symbolori',
   field_name_en = 'symbolori',
   field_name_de = 'SymbolOri',
   field_name_fr = 'SymboleOri',
   field_name_it = 'simboloori',
   field_name_ro = 'simbolori',
   field_description_en = 'Default: 90 degree',
   field_description_de = 'Default: 90 Grad',
   field_description_fr = 'Default: 90 degre',
   field_description_it = 'Default: 90 gradi',
   field_description_ro = '',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'decimal(4,1)',
   field_unit_en = '[degrees]',
   field_unit_description_en = 'Degree',
   field_unit_de = '[Altgrad]',
   field_unit_description_de = '[Altgrad]',
   field_unit_fr = '[degres]',
   field_unit_description_fr = 'degrées [degres]',
   field_unit_it = '[vecchi gradi]',
   field_unit_description_it = 'vecchi gradi',
   field_unit_ro = 'rrr_[Altgrad]',
   field_unit_description_ro = 'rrr_Altgrad',
   field_max = 359.9,
   field_min = 0
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_name_it = 'spessore',
   field_name_ro = 'adancime',
   field_description_en = 'Extension3D, Fonction (calculated value) = altitude minus altitude_lower_edge',
   field_description_de = 'Erweiterung 3D, Funktion (berechneter Wert) = Hoehe minus Hoehe_UK.',
   field_description_fr = 'Extension 3D, Fonction (valuer calculée) = Altitude minus Altitude_BI.',
   field_description_it = 'zzz_Erweiterung 3D, Funktion (berechneter Wert) = Hoehe minus Hoehe_UK.',
   field_description_ro = 'rrr_Erweiterung 3D, Funktion (berechneter Wert) = Hoehe minus Hoehe_UK.',
   field_mandatory = ARRAY['Leitungskataster','Werkinformation']::tww_od.plantype[],
   field_visible = 'true',
   field_datatype = 'smallint',
   field_unit_en = '[mm]',
...
UPDATE tww_sys.dictionary_od_field  SET
   ...
   field_unit_description_en = 'Swiss national grid coordinates',
   field_unit_de = '[HKoord]',
   field_unit_description_de = 'Schweizer Landeskoordinaten [HKoord]',
   field_unit_fr = '[CoordH]',
   field_unit_description_fr = 'coordonnées dans le système de coordonnées suisse',
   field_unit_it = '[HKoord]',
   field_unit_description_it = 'Coordinate nazionali Svizzera',
   field_unit_ro = '[HKoord]',
   field_unit_description_ro = 'rrr_Schweizer Landeskoordinaten [HKoord]',
   field_max = NULL,
   field_min = NULL
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'signal_cable',
   shortcut_en = '',
   value_name_de = 'Signalkabel',
   shortcut_de = '',
   value_name_fr = 'cable_de_signal',
   shortcut_fr = '',
   value_name_it = 'cavo_di_segnale',
   shortcut_it = '',
   value_name_ro = 'cablu_de_semnal',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'control_cable',
   shortcut_en = '',
   value_name_de = 'Steuerkabel',
   shortcut_de = '',
   value_name_fr = 'cable_de_conduite',
   shortcut_fr = '',
   value_name_it = 'cavo_di_comando',
   shortcut_it = '',
   value_name_ro = 'cablu_de_control',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'power_cable',
   shortcut_en = '',
   value_name_de = 'Stromkabel',
   shortcut_de = '',
   value_name_fr = 'cable_de_courant',
   shortcut_fr = '',
   value_name_it = 'cavo_di_alimentazione',
   shortcut_it = '',
   value_name_ro = 'cablu_de_alimentare',
   shortcut_ro = '',
   value_description_en = 'for district heating only',
   value_description_de = 'nur bei Fernwärme',
   value_description_fr = 'uniquement pour le chauffage à distance',
   value_description_it = 'zzz_nur bei Fernwärme',
   value_description_ro = 'zzz_nur bei Fernwärme'
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   field_name = 'function',
   value_name = 'others',
   value_name_en = 'others',
   shortcut_en = '',
   value_name_de = 'weitere',
   shortcut_de = '',
   value_name_fr = 'autres',
   shortcut_fr = '',
   value_name_it = 'zzz_weitere',
   shortcut_it = '',
   value_name_ro = 'rrr_weitere',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   field_name = 'cable_type',
   value_name = 'copper',
   value_name_en = 'copper',
   shortcut_en = '',
   value_name_de = 'Kupfer',
   shortcut_de = '',
   value_name_fr = 'cuivre',
   shortcut_fr = '',
   value_name_it = 'zzz_rame',
   shortcut_it = '',
   value_name_ro = 'zzz_Kupfer',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   field_name = 'cable_type',
   value_name = 'coaxial',
   value_name_en = 'coaxial',
   shortcut_en = '',
   value_name_de = 'koaxial',
   shortcut_de = '',
   value_name_fr = 'coaxial',
   shortcut_fr = '',
   value_name_it = 'zzz_coassiale',
   shortcut_it = '',
   value_name_ro = 'rrr_koaxial',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'fiber_optic',
   shortcut_en = '',
   value_name_de = 'Lichtwellenleiter',
   shortcut_de = '',
   value_name_fr = 'optique',
   shortcut_fr = '',
   value_name_it = 'zzz_Lichtwellenleiter',
   shortcut_it = '',
   value_name_ro = 'rrr_Lichtwellenleiter',
   shortcut_ro = '',
   value_description_en = 'Fiber optic cable',
   value_description_de = '',
   value_description_fr = '',
   value_description_it = '',
   value_description_ro = ''
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   field_name = 'horizontal_positioning',
   value_name = 'accurate',
   value_name_en = 'accurate',
   shortcut_en = '',
   value_name_de = 'genau',
   shortcut_de = '',
   value_name_fr = 'precis',
   shortcut_fr = '',
   value_name_it = 'precisa',
   shortcut_it = '',
   value_name_ro = 'precisa',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'inaccurate',
   shortcut_en = '',
   value_name_de = 'ungenau',
   shortcut_de = '',
   value_name_fr = 'imprecis',
   shortcut_fr = '',
   value_name_it = 'impreciso',
   shortcut_it = '',
   value_name_ro = 'imprecisa',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'inoperative',
   shortcut_en = '',
   value_name_de = 'ausser_Betrieb',
   shortcut_de = '',
   value_name_fr = 'hors_service',
   shortcut_fr = '',
   value_name_it = 'fuori_servizio',
   shortcut_it = '',
   value_name_ro = 'rrr_ausser_Betrieb',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'inoperative.reserve',
   shortcut_en = '',
   value_name_de = 'ausser_Betrieb.Reserve',
   shortcut_de = '',
   value_name_fr = 'hors_service.en_reserve',
   shortcut_fr = '',
   value_name_it = 'fuori_servizio.riserva',
   shortcut_it = '',
   value_name_ro = 'rrr_ausser_Betrieb.Reserve',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'operational',
   shortcut_en = '',
   value_name_de = 'in_Betrieb',
   shortcut_de = '',
   value_name_fr = 'en_service',
   shortcut_fr = '',
   value_name_it = 'in_funzione',
   shortcut_it = '',
   value_name_ro = 'functionala',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'operational.tentative',
   shortcut_en = '',
   value_name_de = 'in_Betrieb.provisorisch',
   shortcut_de = '',
   value_name_fr = 'en_service.provisoire',
   shortcut_fr = '',
   value_name_it = 'in_funzione.provvisorio',
   shortcut_it = '',
   value_name_ro = 'functionala.provizoriu',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'other.calculation_alternative',
   shortcut_en = '',
   value_name_de = 'weitere.Berechnungsvariante',
   shortcut_de = '',
   value_name_fr = 'autre.variante_de_calcule',
   shortcut_fr = '',
   value_name_it = 'altro.variante_calcolo',
   shortcut_it = '',
   value_name_ro = 'alta.varianta_calcul',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'other.planned',
   shortcut_en = '',
   value_name_de = 'weitere.geplant',
   shortcut_de = '',
   value_name_fr = 'autre.planifie',
   shortcut_fr = '',
   value_name_it = 'altro.previsto',
   shortcut_it = '',
   value_name_ro = 'rrr_weitere.geplant',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'other.project',
   shortcut_en = '',
   value_name_de = 'weitere.Projekt',
   shortcut_de = '',
   value_name_fr = 'autre.projet',
   shortcut_fr = '',
   value_name_it = 'altro.progetto',
   shortcut_it = '',
   value_name_ro = 'alta.proiect',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'cable_sleeve',
   shortcut_en = '',
   value_name_de = 'Kabelmuffe',
   shortcut_de = '',
   value_name_fr = 'manchon_cable',
   shortcut_fr = '',
   value_name_it = 'manicotto_del_cavo',
   shortcut_it = '',
   value_name_ro = 'manson_de_cablu',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'cable_manhole',
   shortcut_en = '',
   value_name_de = 'Kabelschacht',
   shortcut_de = '',
   value_name_fr = 'chambre_cable',
   shortcut_fr = '',
   value_name_it = '',
   shortcut_it = '',
   value_name_ro = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   field_name = 'kind',
   value_name = 'cabine',
   value_name_en = 'cabine',
   shortcut_en = '',
   value_name_de = 'Kabine',
   shortcut_de = '',
   value_name_fr = 'cabine',
   shortcut_fr = '',
   value_name_it = 'cabina',
   shortcut_it = '',
   value_name_ro = 'cabina',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
...
UPDATE tww_sys.dictionary_od_values SET
   ...
   value_name_en = 'cable_point',
   shortcut_en = '',
   value_name_de = 'Kabelpunkt',
   shortcut_de = '',
   value_name_fr = 'point_de_cable',
   shortcut_fr = '',
   value_name_it = 'punto_cavo',
   shortcut_it = '',
   value_name_ro = 'punct_de_cablu',
   shortcut_ro = '',
   value_description_en = '',
   value_description_de = '',
   value_description_fr = '',
