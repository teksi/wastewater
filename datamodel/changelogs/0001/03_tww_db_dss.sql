...
ALTER TABLE tww_od.log_card ADD COLUMN fk_main_special_structure varchar(16);
ALTER TABLE tww_od.log_card ADD CONSTRAINT rel_log_card_main_special_structure FOREIGN KEY (fk_main_special_structure) REFERENCES tww_od.log_card(obj_id) ON UPDATE CASCADE ON DELETE set null DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE tww_od.log_card ADD COLUMN fk_next_special_structure varchar(16);
ALTER TABLE tww_od.log_card ADD CONSTRAINT rel_log_card_next_special_structure FOREIGN KEY (fk_next_special_structure) REFERENCES tww_od.log_card(obj_id) ON UPDATE CASCADE ON DELETE set null DEFERRABLE INITIALLY DEFERRED;
